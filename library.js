...
class entity extends mutall{
    ...
    present(svg,comment=null){
        ...
        if (visible===true){
         ...
         //
         //If the entity is not visible do nothing but set the visibility to false 
         else {
             //
             //
         }
        ...
        if (visible===true){ 
            ...
            //plot the ellipse using the kld intersectiion library 
             ...
             //If the coordinates are correctly alligned with no similarity present the relation
                ...
                this.line.setAttribute('class', 's_line');
