//
// 
import * as schema from "./schemats"
...
export class database {
    ...
    get_sql_data(sql: string): Array<{[index:string]:basic_value}>;
    //
...
export class editor {
   //
    ...
    //CRUD table.
    describe():[schema.Idatabase, Array<cname>, sql, number];
}
...
export class record {
    ...
    export(            
        ...
        keep_log: boolean,
        roll_back_on_fatal_error: boolean
    ):Imala;
}
//
...
//
//This interface is designed for reporting the crud updates 
//operations
interface Imala{
    //
    //The type of update/write result
    class_name:"syntax"|"runtime";
    //
