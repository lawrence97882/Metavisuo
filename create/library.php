...
trait mutall{
    ...
    //Try to bind the named property of this object to the given value, e.g.,
    //$this->cx = $cx; if the prperty is not found return false
    ...
    //Bind the named property of this object to the given value, e.g.,
    //$this->cx = $cx; if the prperty is not found throw an execption.
...
class database extends PDO{
    ...
    //Update the entities' coordinates to on this database.
    function update_entity_coordinates($coordinates=null){
        //
        $this->bind_arg('coordinates', $coordinates);
        //
        //Decode the coordinates to a php version
        $this->coordinates = json_decode($coordinates);
        //
        //loop through the coodinates array and update the coodinates at the table column 
        //using the sql alter command.
        foreach ($this->coordinates as $coordinate){
            //
            //Get the existing entity comment 
            $comment= $this->entities[$coordinate->name]->comment;
            //
            //Add coodinates to the comment if they do not exist or update the existing ones
            //
            //update the coodinates of this entity 
            $comment->cx= $coordinate->cx;
            $comment->cy= $coordinate->cy;                
            //
            //Stringify the comment
            $comment_str = json_encode($comment); 
            //
